...
exports.verifyCoursePayment = async (req, res) => {
    try {
        ...
        const pending = await CoursePurchase.findOne({
        ...
        // Stored in rupees; Razorpay reports paise.
        ...
        // Conditional update keeps enrolledCount from being inflated by replays.
